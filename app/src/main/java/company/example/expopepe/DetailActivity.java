...
public class DetailActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_IMAGE = "company.example.expopepe.extraImage";
    private static final String EXTRA_TITLE = "company.example.expopepe.extraTitle";
    ...
    private void initActivityTransitions() {
        ...
        //obtener la version del sistema android
